...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTERACTIVEF)
extern struct cpufreq_governor cpufreq_gov_interactivef;
#define CPUFREQ_DEFAULT_GOVERNOR        (&cpufreq_gov_interactivef)
#endif
